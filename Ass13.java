...
class Professor extends Employee
{
	...
	void setData(String course,long salary,Date dateOfJoining,int experience,int age,double weight,double height,Date dateOfBirth,String address)
    ...
    void show()
    {
    	...
    	System.out.println("                 "+ listOfAdvisee[1]);		                     
        System.out.println("                 " + listOfAdvisee[2]);
    }
...
class Ass13
{
	public static void main(String args[])
	{
		...
		e.setData(45000L,d2,2,23,50.0,5.0,d1,"Jalpaiguri");
		e.show();
		Student st=new Student();
		st.setData(1,23,60.0,6.0,d1,"Kolkata");
		st.show();
		System.out.println(" Calculate Grade "+st.calculateGrade(100));
		System.out.println(" Calculate Grade "+st.calculateGrade(25));
		Technician t=new Technician();
		t.setData(70000L,d2,3,23,55.0,5.5,d2,"Siliguri");
		t.show();
		Professor pr=new Professor();
		pr.setData("Webdevlopment",35000L,d2,2,22,65.0,5.0,d1,"Sikim");
		pr.show();
	}
}
